...
contextBridge.exposeInMainWorld('api', {
    ...
    openLearnCourseWindow: (courseId) => ipcRenderer.send('open-learn-course-window', courseId),
    startLearning: (courseId) => ipcRenderer.on('start-learning', courseId),
    closeLearnCourseWindow: () => ipcRenderer.send('close-learn-course-window'),
    openQuizWindow: (quizData) => ipcRenderer.send('open-quiz-window', quizData),
    closeQuizWindow: () => ipcRenderer.send('close-quiz-window'),
    startQuiz: (quizData) => ipcRenderer.on('start-quiz', quizData),
