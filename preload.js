...
contextBridge.exposeInMainWorld('api', {
    ...
    getCourseActivation: (categoryId) => ipcRenderer.invoke('get-course-activation', categoryId),
    ...
    validateCourseActivation: (activationCode, categoryId) => ipcRenderer.invoke('validate-course-activation', activationCode, categoryId),
